...
Dicen que, cuando cae la noche, los trimestres susurran secretos y nosotros los escuchamos para convertirlos en gráficos que estremecen (pero que siempre pasan por control de calidad). Si algo huele a error o a etiqueta mal escrita, allí aparece un panda con su cuaderno para registrarlo todo.
