...
### 🔍 Criminal Pandas 🔪🩸
Analizamos los datos de España en el año 2024 para conocer sus tendencias de criminalidad por comunidades autónomas. Así podremos priorizar recursos, diseñar intervenciones y prevenir delitos.
...
Dicen que, cuando cae la noche, los trimestres susurran secretos y nosotros los escuchamos para convertirlos en gráficos que estremecen (pero que siempre pasan por control de calidad). Si algo huele a error o a etiqueta mal escrita, allí aparece un panda con su cuaderno de notas para registrarlo todo.
